...
public class DocumentService {
    ...
    public static ODocument create(String appName, String collection, JsonNode bodyJson) throws Throwable, InvalidCollectionException,InvalidModelException {
        DocumentDao dao = DocumentDao.getInstance(appName, collection);
    ...
    public static ODocument update(String appName, String collectionName,String rid, JsonNode bodyJson) throws InvalidCollectionException,InvalidModelException, ODatabaseException, IllegalArgumentException, DocumentNotFoundException, UpdateOldVersionException {
        ODocument doc=get(appName, collectionName,rid);
        if (doc==null) throw new InvalidParameterException(rid + " is not a valid document");
        //update the document
    ...
    public static ODocument get(String appName, String collectionName,String rid) throws IllegalArgumentException,InvalidCollectionException,InvalidModelException, ODatabaseException, DocumentNotFoundException {
        DocumentDao dao = DocumentDao.getInstance(appName, collectionName);
        ODocument doc=dao.get(rid);
        return doc;
    }
    ...
    public static ODocument get(String appName, String collectionName,String rid,PartsParser parser) throws IllegalArgumentException,InvalidCollectionException,InvalidModelException, ODatabaseException, DocumentNotFoundException, InvalidCriteriaException {
        DocumentDao dao = DocumentDao.getInstance(appName, collectionName);
        ODocument doc=dao.get(rid);
        if(parser.isMultiField()){
            Object v = doc.field(parser.treeFields());
        ...
        String name = appName + "_" + collectionName;
        StringBuffer q = new StringBuffer();
        q.append("select ")
                .append(parser.fullTreeFields())
                .append(" as ").append(OBJECT_QUERY_ALIAS)
    ...
    public static void delete(String appName, String collectionName, String rid) throws Throwable {
        DocumentDao dao = DocumentDao.getInstance(appName, collectionName);
        try {
            dao.delete(rid);
        } catch (InvalidModelException e) {
    ...
    public static ODocument grantPermissionToUser(String appName, String collectionName, String rid, Permissions permission, String username) throws UserNotFoundException, IllegalArgumentException, InvalidCollectionException, InvalidModelException, DocumentNotFoundException {
        OUser user=UserService.getOUserByUsername(username);
        if (user==null) throw new UserNotFoundException(username);
        ODocument doc = get(appName, collectionName, rid);
        if (doc==null) throw new DocumentNotFoundException(rid);
    ...
    public static ODocument revokePermissionToUser(String appName, String collectionName, String rid, Permissions permission, String username) throws UserNotFoundException, IllegalArgumentException, InvalidCollectionException, InvalidModelException, DocumentNotFoundException {
        OUser user=UserService.getOUserByUsername(username);
        if (user==null) throw new UserNotFoundException(username);
        ODocument doc = get(appName, collectionName, rid);
        if (doc==null) throw new DocumentNotFoundException(rid);
    ...
    public static ODocument grantPermissionToRole(String appName, String collectionName, String rid, Permissions permission, String rolename) throws RoleNotFoundException, IllegalArgumentException, InvalidCollectionException, InvalidModelException, DocumentNotFoundException {
        ORole role=RoleDao.getRole(rolename);
        if (role==null) throw new RoleNotFoundException(rolename);
        ODocument doc = get(appName, collectionName, rid);
        if (doc==null) throw new DocumentNotFoundException(rid);
    ...
    public static ODocument revokePermissionToRole(String appName, String collectionName, String rid, Permissions permission, String rolename) throws  IllegalArgumentException, InvalidCollectionException, InvalidModelException, DocumentNotFoundException, RoleNotFoundException {
        ORole role=RoleDao.getRole(rolename);
        if (role==null) throw new RoleNotFoundException(rolename);
        ODocument doc = get(appName, collectionName, rid);
        if (doc==null) throw new DocumentNotFoundException(rid);
    ...
    public static ODocument update(String appName, String collectionName, String rid,
                                   JsonNode bodyJson, PartsParser pp) throws MissingNodeException, InvalidCollectionException,InvalidModelException, ODatabaseException, IllegalArgumentException, DocumentNotFoundException {
        ODocument od = get(rid);
        if (od==null) throw new InvalidParameterException(rid + " is not a valid document");
        ObjectMapper mapper = new ObjectMapper();
        ...
        q.append(" where @rid = ").append(rid);
        try{
            DocumentDao.getInstance(appName, collectionName).updateByQuery(q.toString());
        }catch(OSecurityException  e){
            throw e;
        } catch (InvalidCriteriaException e) {
            throw new RuntimeException (e);
