...
create property _BB_File.appid String;
alter property _BB_File.appid mandatory=true;
alter property _BB_File.appid notnull=true;
...
create property _BB_Asset.appid String;
alter property _BB_Asset.appid mandatory=true;
alter property _BB_Asset.appid notnull=true;
